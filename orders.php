<html>
  <?php
    ...
    {
      echo "<form method=post action=http://students.cs.niu.edu/~z1853066/CSCI467/Main/orders.php>";
        echo "<input type=submit name='viewall'
                     value='View All Orders'/>";
      echo "</form>";

      echo "<form method=post action=http://students.cs.niu.edu/~z1853066/CSCI467/Main/weights.php>";
      ...
      echo "<table border=3>";
        ...
        foreach($allorders as $order)
        {
          echo "<tr>";
            ...
            echo "<td>";
              echo "<form method=post action =http://students.cs.niu.edu/~z1853066/CSCI467/Main/orderdetails.php>";
