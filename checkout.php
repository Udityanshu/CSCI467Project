<html>
  <?php
	...
	echo'<title> 1A CSCI 467 Checkout - Z1851835</title>';
...
$cartcontents = array();
  ...
  try
  {
    $dsn1 = "mysql:host=courses;dbname=z1851835";
...
echo "Card Expiration Date: ";
  ...
  else
  {
    ...
    else
    {
      ...
      $cartcontents = array();
      echo "<form method=post action=http://students.cs.niu.edu/~z1851835/catelog.php>";
