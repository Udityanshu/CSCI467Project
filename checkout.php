...
$cartcontents = array();
  ...
  echo "<form method=post action=http://students.cs.niu.edu/~z1853066/CSCI467/cart.php>";
  ...
  if (!(array_key_exists('placeorder', $_REQUEST)))
  {
    echo "<form method=post action=http://students.cs.niu.edu/~z1853066/CSCI467/checkout.php>";
      ...
      echo  '<small>(The format is "1234 1234 1234 1234")</small>';
	echo "<br><br>";
